...
export function PluginShareMenu({ record, variant = 'default' }: Props) {
  ...
  const items: ShareItem[] = [
    {
      key: 'install',
      label: t('pluginShare.copyInstallCommand'),
      icon: 'copy',
      copies: true,
    ...
    {
      key: 'id',
      label: t('pluginShare.copyPluginId'),
      icon: 'copy',
      copies: true,
    ...
    {
      key: 'link',
      label: t('pluginShare.copyShareLink'),
      icon: 'link',
      copies: true,
    ...
    {
      key: 'badge',
      label: t('pluginShare.copyMarkdownBadge'),
      icon: 'copy',
      copies: true,
    ...
    openItems.push({
      ...
      label:
        record.sourceKind === 'github' || links.sourceUrl.includes('github.com/')
          ? t('pluginShare.openSourceGithub')
          : t('pluginShare.openSource'),
  ...
  if (links.homepageUrl) {
    openItems.push({
      key: 'homepage',
      label: t('pluginShare.openHomepage'),
      icon: 'external-link',
  ...
  openItems.push({
    key: 'marketplace',
    label: t('pluginShare.openMarketplace'),
    icon: 'eye',
          ...
          <div className="plugin-share-popover__group">
            {items.map((item) => (
              ...
              >
                ...
                />
                <span>
                  {copiedKey === item.key ? t('pluginShare.copied') : item.label}
                </span>
              </button>
            ))}
          </div>
