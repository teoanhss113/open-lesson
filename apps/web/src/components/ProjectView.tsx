...
import { useProjectPanelLayout, MIN_CHAT_PANEL_WIDTH, SPLIT_RESIZE_HANDLE_WIDTH } from '../hooks/useProjectPanelLayout';
import { useProjectArtifactEvents } from '../hooks/useProjectArtifactEvents';
import { useProjectAutoSend } from '../hooks/useProjectAutoSend';
...
export function ProjectView({
  ...
  } = useProjectArtifactEvents(project.id);
  ...
  const handleProjectEvent = useCallback((evt: ProjectEvent) => {
    ...
    appendArtifactEvent(agentEvent);
