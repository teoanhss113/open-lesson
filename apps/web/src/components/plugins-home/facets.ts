...
// into the workspace, create new artifacts, ship downstream framework
...
const PRIMARY_CATEGORIES: readonly CategoryDef[] = [
  {
    slug: 'import',
    label: 'Import',
    starterPrompt: 'Create a plugin that imports a source into a project and normalizes it into editable artifacts.',
    test: isSourcePlugin,
  },
  {
    slug: 'create',
    label: 'Create',
    starterPrompt: 'Create a plugin that generates a reusable artifact from a short user brief.',
    test: isCreatePlugin,
  },
  {
    slug: 'export',
    label: 'Export',
    starterPrompt: 'Create a plugin that exports an accepted artifact into a downstream file or framework handoff.',
    test: isExportPlugin,
  },
  {
    slug: 'share',
    label: 'Share',
    starterPrompt: 'Create a plugin that packages an accepted artifact for sharing with collaborators.',
    test: isSharePlugin,
  },
  {
    slug: 'deploy',
    label: 'Deploy',
    starterPrompt: 'Create a plugin that deploys an accepted artifact to a hosted downstream surface.',
    test: isDeployPlugin,
  },
  {
    slug: 'refine',
    label: 'Refine',
    starterPrompt: 'Create a plugin that reviews, patches, and improves an existing artifact.',
    test: isRefinePlugin,
  },
  {
    slug: 'extend',
    label: 'Extend',
    starterPrompt: 'Create a plugin that extends the plugin catalog or authoring workflow.',
    test: isExtendPlugin,
  },
];
...
const SUBCATEGORIES: readonly SubcategoryDef[] = [
  {
    ...
    slug: 'from-figma',
    label: 'Figma',
    starterPrompt: 'Create a plugin that imports a Figma file or frame URL and rebuilds it as editable artifacts.',
  ...
  },
  {
    ...
    slug: 'from-github',
    label: 'GitHub',
    starterPrompt: 'Create a plugin that imports a GitHub repository or path, discovers the design entrypoints, and prepares an editable workspace.',
  ...
  },
  {
    ...
    slug: 'from-code',
    label: 'Code / folder',
    starterPrompt: 'Create a plugin that imports a local code folder and turns the relevant UI into an editable design artifact.',
  ...
  },
  {
    ...
    slug: 'from-url',
    label: 'URL',
    starterPrompt: 'Create a plugin that imports a public URL, captures the page structure, and recreates it as an editable artifact.',
  ...
  },
  {
    ...
    label: 'Screenshot',
    starterPrompt: 'Create a plugin that imports a screenshot or image reference and reconstructs a matching editable UI.',
  ...
  },
  {
    ...
    slug: 'from-pdf',
    label: 'PDF',
    starterPrompt: 'Create a plugin that imports a PDF and converts key pages into editable artifacts.',
  ...
  },
  {
    ...
    slug: 'from-pptx',
    label: 'PPTX',
    starterPrompt: 'Create a plugin that imports a PPTX deck and converts slides into editable deck artifacts.',
  ...
  },
  {
    ...
    slug: 'from-framer',
    label: 'Framer',
    starterPrompt: 'Create a plugin that imports a Framer site or project export and rebuilds it as editable components.',
  ...
  },
  {
    ...
    slug: 'from-webflow',
    label: 'Webflow',
    starterPrompt: 'Create a plugin that imports a Webflow site export and maps it into editable artifacts.',
  ...
  },
  {
    ...
    slug: 'design-system',
    label: 'Design system',
    starterPrompt: 'Create a plugin that generates a reusable design system from brand and product constraints.',
  ...
  },
  {
    ...
    slug: 'pptx',
    label: 'PPTX',
    starterPrompt: 'Create a plugin that exports an accepted deck artifact to PPTX with high visual fidelity.',
    test: byAnySlugPart('pptx', 'ppt'),
  },
  {
    parent: 'export',
    slug: 'pdf',
    label: 'PDF',
    starterPrompt: 'Create a plugin that exports an accepted artifact to a polished PDF package.',
    test: byAnySlugPart('pdf'),
  },
  {
    parent: 'export',
    slug: 'html',
    label: 'HTML',
    starterPrompt: 'Create a plugin that exports an accepted artifact to standalone HTML.',
    test: byAnySlug('html'),
  },
  {
    parent: 'export',
    slug: 'zip',
    label: 'ZIP',
    starterPrompt: 'Create a plugin that exports an accepted artifact as a portable ZIP bundle.',
    test: byAnySlug('zip'),
  },
  {
    parent: 'export',
    slug: 'markdown',
    label: 'Markdown',
    starterPrompt: 'Create a plugin that exports an accepted artifact to Markdown with asset references.',
  ...
  },
  {
    ...
    slug: 'figma',
    label: 'Figma',
    starterPrompt: 'Create a plugin that exports an accepted artifact into a Figma-ready handoff package.',
  ...
  },
  {
    ...
    slug: 'nextjs',
    label: 'Next.js',
    starterPrompt: 'Create a plugin that exports an accepted artifact to a Next.js App Router implementation.',
  ...
  },
  {
    ...
    slug: 'reactjs',
    label: 'React.js',
    starterPrompt: 'Create a plugin that exports an accepted artifact to a React component handoff.',
  ...
  },
  {
    ...
    slug: 'vuejs',
    label: 'Vue.js',
    starterPrompt: 'Create a plugin that exports an accepted artifact to a Vue single-file component.',
  ...
  },
  {
    ...
    slug: 'sveltejs',
    label: 'Svelte.js',
    starterPrompt: 'Create a plugin that exports an accepted artifact to a Svelte component.',
  ...
  },
  {
    ...
    slug: 'astro',
    label: 'Astro',
    starterPrompt: 'Create a plugin that exports an accepted artifact to an Astro component or page.',
  ...
  },
  {
    ...
    slug: 'angular',
    label: 'Angular',
    starterPrompt: 'Create a plugin that exports an accepted artifact to an Angular component.',
  ...
  },
  {
    ...
    slug: 'tailwind',
    label: 'Tailwind',
    starterPrompt: 'Create a plugin that exports an accepted artifact using Tailwind CSS classes.',
  ...
  },
  {
    ...
    slug: 'public-link',
    label: 'Public link',
    starterPrompt: 'Create a plugin that publishes an accepted artifact to a shareable public link.',
  ...
  },
  {
    ...
    slug: 'github-pr',
    label: 'GitHub PR',
    starterPrompt: 'Create a plugin that opens a GitHub pull request with the accepted artifact changes.',
  ...
  },
  {
    ...
    slug: 'github-gist',
    label: 'GitHub Gist',
    starterPrompt: 'Create a plugin that publishes an accepted artifact as a GitHub Gist.',
  ...
  },
  {
    ...
    slug: 'slack',
    label: 'Slack',
    starterPrompt: 'Create a plugin that shares an accepted artifact summary and link to Slack.',
  ...
  },
  {
    ...
    slug: 'discord',
    label: 'Discord',
    starterPrompt: 'Create a plugin that shares an accepted artifact summary and link to Discord.',
  ...
  },
  {
    ...
    slug: 'notion',
    label: 'Notion',
    starterPrompt: 'Create a plugin that publishes an accepted artifact and notes into Notion.',
  ...
  },
  {
    ...
    slug: 'linear',
    label: 'Linear',
    starterPrompt: 'Create a plugin that posts an accepted artifact update to a Linear issue.',
  ...
  },
  {
    ...
    slug: 'jira',
    label: 'Jira',
    starterPrompt: 'Create a plugin that posts an accepted artifact update to a Jira ticket.',
    test: byAnySlug('jira'),
  },
  {
    parent: 'deploy',
    slug: 'vercel',
    label: 'Vercel',
    starterPrompt: 'Create a plugin that deploys an accepted web artifact to Vercel and returns preview and production links.',
  ...
  },
  {
    ...
    slug: 'cloudflare',
    label: 'Cloudflare',
    starterPrompt: 'Create a plugin that deploys an accepted web artifact to Cloudflare Pages.',
  ...
  },
  {
    ...
    slug: 'netlify',
    label: 'Netlify',
    starterPrompt: 'Create a plugin that deploys an accepted web artifact to Netlify.',
  ...
  },
  {
    ...
    slug: 'github-pages',
    label: 'GitHub Pages',
    starterPrompt: 'Create a plugin that deploys an accepted static artifact to GitHub Pages.',
  ...
  },
  {
    ...
    slug: 'fly-io',
    label: 'Fly.io',
    starterPrompt: 'Create a plugin that deploys an accepted app artifact to Fly.io.',
  ...
  },
  {
    ...
    slug: 'render',
    label: 'Render',
    starterPrompt: 'Create a plugin that deploys an accepted app artifact to Render.',
  ...
  },
  {
    ...
    slug: 'docker',
    label: 'Docker',
    starterPrompt: 'Create a plugin that packages an accepted app artifact into a Docker-ready handoff.',
  ...
  },
  {
    ...
    slug: 'tune',
    label: 'Tune',
    starterPrompt: 'Create a plugin that tunes an existing artifact based on user feedback.',
  ...
  },
  {
    ...
    slug: 'review',
    label: 'Review',
    starterPrompt: 'Create a plugin that reviews an existing artifact and proposes concrete fixes.',
  ...
  },
  {
    ...
    starterPrompt: 'Create a plugin that helps users author, validate, and install new plugins.',
