...
export interface Dict {
  ...
  'settings.curriculum'?: string;
  'settings.curriculumHint'?: string;
  'settings.curriculum.defaultAgeGroup'?: string;
  'settings.curriculum.defaultAgeGroupHint'?: string;
  'settings.curriculum.defaultLevel'?: string;
  'settings.curriculum.defaultLevelHint'?: string;
  'settings.curriculum.defaultSkillId'?: string;
  'settings.curriculum.defaultSkillIdHint'?: string;
  ...
  'workspaceTabs.label'?: string;
  'workspaceTabs.projectMeta'?: string;
  'workspaceTabs.pluginDetails'?: string;
  'workspaceTabs.marketplace'?: string;
  'workspaceTabs.pluginsMeta'?: string;
  'workspaceTabs.showHidden'?: string;
  'workspaceTabs.more'?: string;
  'workspaceTabs.newTab'?: string;
  'workspaceTabs.searchTabs'?: string;
  'workspaceTabs.openTabs'?: string;
  'workspaceTabs.noTabsFound'?: string;
  'pluginShare.title'?: string;
  'pluginShare.copyInstallCommand'?: string;
  'pluginShare.copyPluginId'?: string;
  'pluginShare.copyShareLink'?: string;
  'pluginShare.copyMarkdownBadge'?: string;
  'pluginShare.openSourceGithub'?: string;
  'pluginShare.openSource'?: string;
  'pluginShare.openHomepage'?: string;
  'pluginShare.openMarketplace'?: string;
  'pluginShare.copied'?: string;
  'homeHero.attachFiles'?: string;
  'homeHero.run'?: string;
  'homeHero.runDisabledTitle'?: string;
  'homeHero.keyboardHint'?: string;
  ...
  'homeHero.chip.fromFigma'?: string;
  'homeHero.chip.fromFolder'?: string;
  'homeHero.chip.fromTemplate'?: string;
  'homeHero.hint.liveArtifact'?: string;
  'homeHero.hint.hyperframes'?: string;
  'homeHero.hint.createPlugin'?: string;
  'homeHero.hint.fromFigma'?: string;
  'homeHero.hint.fromFolder'?: string;
  'homeHero.hint.fromTemplate'?: string;
  'home.recentProjectsTitle'?: string;
  'home.recentProjectsViewAll'?: string;
  'home.recentProjectsEmpty'?: string;
  ...
  'designFiles.uploadFolder.title': string;
  'designFiles.uploadFolder.label': string;
  ...
  'designFiles.groupByStage'?: string;
  'designFiles.groupByFolder'?: string;
  'designFiles.groupBySize'?: string;
  'designFiles.filterByLabel'?: string;
  'designFiles.filterAll'?: string;
  'designFiles.familySlides'?: string;
  'designFiles.familyDocs'?: string;
  'designFiles.familyVideo'?: string;
  'designFiles.familyAudio'?: string;
  'designFiles.familyData'?: string;
  'designFiles.familyWeb'?: string;
  'designFiles.stageMaterial'?: string;
  'designFiles.stageHomework'?: string;
  'designFiles.sizeTiny'?: string;
  'designFiles.sizeSmall'?: string;
  'designFiles.sizeMedium'?: string;
  'designFiles.sizeLarge'?: string;
  'designFiles.sizeHuge'?: string;
  'designFiles.rootFolder'?: string;
  'slideViewer.loading'?: string;
  'slideViewer.fallback'?: string;
  'slideViewer.parsedLocally'?: string;
  'slideViewer.parsedLocallyTitle'?: string;
  'slideViewer.unavailable'?: string;
  'slideViewer.prev'?: string;
  'slideViewer.next'?: string;
  'slideViewer.position'?: string;
  'slideViewer.openInTab'?: string;
  'slideViewer.thumbnailAria'?: string;
  'slideViewer.slideTitle'?: string;
  ...
  'designFiles.folderItemCount': string;
  ...
  'fileViewer.visualPreview'?: string;
  'fileViewer.textView'?: string;
  'fileViewer.commentPicker'?: string;
  'fileViewer.commentPickerTitle'?: string;
  'fileViewer.commentPods'?: string;
  'fileViewer.commentPodsTitle'?: string;
  'fileViewer.inspectHintClose'?: string;
  'fileViewer.inspectHintAction'?: string;
  'fileViewer.commentHintAction'?: string;
  'fileViewer.targetHintPrefix'?: string;
  'fileViewer.inspectPanelClose'?: string;
  'fileViewer.inspectPanelColors'?: string;
  'fileViewer.inspectPanelText'?: string;
  'fileViewer.inspectPanelBackground'?: string;
  'fileViewer.inspectPanelTypography'?: string;
  'fileViewer.inspectPanelSize'?: string;
  'fileViewer.inspectPanelWeight'?: string;
  'fileViewer.inspectPanelAlign'?: string;
  'fileViewer.inspectPanelSpacingShape'?: string;
  'fileViewer.inspectPanelPadding'?: string;
  'fileViewer.inspectPanelRadius'?: string;
  'fileViewer.inspectPanelResetElement'?: string;
  'fileViewer.inspectPanelSaving'?: string;
  'fileViewer.inspectPanelSaved'?: string;
  'fileViewer.inspectPanelSaveToSource'?: string;
  ...
  // Curriculum keys
  'curriculum.status.draft'?: string;
  'curriculum.status.in-review'?: string;
  'curriculum.status.approved'?: string;
  'curriculum.status.archived'?: string;
  'curriculum.risk.high'?: string;
  'curriculum.risk.medium'?: string;
  'curriculum.risk.low'?: string;
  'curriculum.risk.passed'?: string;
  'curriculum.sidebar.lessonPlans'?: string;
  'curriculum.sidebar.teachingGuides'?: string;
  'curriculum.sidebar.slides'?: string;
  'curriculum.sidebar.feedback'?: string;
  'curriculum.sidebar.analysis'?: string;
  'curriculum.sidebar.riskReviews'?: string;
  'curriculum.action.generateLessonPlan'?: string;
  'curriculum.action.analyzeCurriculum'?: string;
  'curriculum.action.validateRollout'?: string;
  'curriculum.hero.title'?: string;
  'curriculum.hero.subtitle'?: string;
  'curriculum.hero.placeholder'?: string;
  'newproj.courseNameLabel'?: string;
  'newproj.moduleNameLabel'?: string;
  'newproj.lessonTitleLabel'?: string;
  'newproj.ageGroupLabel'?: string;
  'newproj.ageFromLabel'?: string;
  'newproj.ageFromPlaceholder'?: string;
  'newproj.ageToLabel'?: string;
  'newproj.ageToPlaceholder'?: string;
  'newproj.levelLabel'?: string;
  'newproj.curriculumVersionLabel'?: string;
  'newproj.titleCurriculumWorkspace'?: string;
  'newproj.curriculumWorkspaceIntro'?: string;
  'newproj.curriculumStarterLabel'?: string;
  'newproj.createCurriculumWorkspace'?: string;
  'newproj.curriculumKindLabel'?: string;
  'newproj.curriculumKind.syllabus'?: string;
  'newproj.curriculumKind.syllabusHint'?: string;
  'newproj.curriculumKind.lessonPlan'?: string;
  'newproj.curriculumKind.teachingGuide'?: string;
  'newproj.curriculumKind.slides'?: string;
  'newproj.curriculumKind.material'?: string;
  'newproj.curriculumKind.materialHint'?: string;
  'newproj.curriculumKind.homework'?: string;
  'newproj.curriculumKind.homeworkHint'?: string;
  'newproj.curriculumKind.curriculumReview'?: string;
  'newproj.curriculumKind.rolloutValidation'?: string;
  'curriculum.filter.all'?: string;
  'curriculum.filter.lessonPlans'?: string;
  'curriculum.filter.teachingGuides'?: string;
  'curriculum.filter.slides'?: string;
  'curriculum.filter.reviews'?: string;

  // Main app pages added for the curriculum workspace shell.
  'home.confirmReplaceTitle'?: string;
  'home.confirmReplaceBody'?: string;
  'home.confirmReplaceAction'?: string;
  'workspace.metaCourse'?: string;
  'workspace.metaModule'?: string;
  'workspace.metaLesson'?: string;
  'workspace.metaAge'?: string;
  'workspace.metaLevel'?: string;
  'workspace.metaVersion'?: string;
  'integrations.kicker'?: string;
  'integrations.title'?: string;
  'integrations.lede'?: string;
  'integrations.badge'?: string;
  'integrations.tabsAria'?: string;
  'integrations.tabMcp'?: string;
  'integrations.tabMcpHint'?: string;
  'integrations.tabConnectors'?: string;
  'integrations.tabConnectorsHint'?: string;
  'integrations.tabSkills'?: string;
  'integrations.tabSkillsHint'?: string;
  'integrations.tabUseEverywhere'?: string;
  'integrations.tabUseEverywhereHint'?: string;
  'integrations.skillsComingSoon'?: string;
  ...
  'tasks.configAria'?: string;
  'tasks.count'?: string;
  'tasks.new'?: string;
  'tasks.filterAll'?: string;
  'tasks.filterScheduled'?: string;
  'tasks.filterRunning'?: string;
  'tasks.filterDone'?: string;
  'tasks.slotTrigger'?: string;
  'tasks.slotPattern'?: string;
  'tasks.slotRuntime'?: string;
  'tasks.slotOutput'?: string;
  'tasks.liveArtifact'?: string;
  'tasks.viewProgress'?: string;
  'tasks.pause'?: string;
  'tasks.runNow'?: string;
  'tasks.openArtifact'?: string;
  'tasks.primitiveOrbitTitle'?: string;
  'tasks.primitiveOrbitBody'?: string;
  'tasks.primitiveOrbitMetaOn'?: string;
  'tasks.primitiveOrbitMetaOff'?: string;
  'tasks.primitiveRoutinesTitle'?: string;
  'tasks.primitiveRoutinesBody'?: string;
  'tasks.primitiveRoutinesMeta'?: string;
  'tasks.primitiveSchedulesTitle'?: string;
  'tasks.primitiveSchedulesBody'?: string;
  'tasks.primitiveSchedulesMeta'?: string;
  'tasks.primitiveArtifactsTitle'?: string;
  'tasks.primitiveArtifactsBody'?: string;
  'tasks.primitiveArtifactsMeta'?: string;
  'tasks.orbitTitle'?: string;
  'tasks.orbitStatusOn'?: string;
  'tasks.orbitStatusOff'?: string;
  'tasks.orbitMetaOn'?: string;
  'tasks.orbitMetaOff'?: string;
  'tasks.orbitPreviewOn'?: string;
  'tasks.orbitPreviewOff'?: string;
  'tasks.orbitTriggerOn'?: string;
  'tasks.orbitTriggerOff'?: string;
  'tasks.orbitPattern'?: string;
  'tasks.orbitRuntime'?: string;
  'tasks.orbitOutput'?: string;
  'tasks.orbitArtifactMetaOn'?: string;
  'tasks.orbitArtifactMetaOff'?: string;
  'tasks.orbitArtifactBody'?: string;
}
