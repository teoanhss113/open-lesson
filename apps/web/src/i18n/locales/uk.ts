...
export const uk: Dict = {
  ...
  'settings.welcomeTitle': 'Налаштування Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon Curriculum Workspace (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Відкрийте Curriculum Workspace як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставити Curriculum Workspace зірку на GitHub',
  ...
  'newproj.importClaudeZip': 'Імпортувати Backup ZIP',
  'newproj.importClaudeZipTitle': 'Імпортувати експорт Backup .zip',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що Curriculum Workspace запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з Curriculum Workspace — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з Curriculum Workspace — завантаження не потрібне.',
