...
export const pl: Dict = {
  ...
  'settings.welcomeTitle': 'Skonfiguruj Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon Curriculum Workspace (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Udostępnij Curriculum Workspace jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.githubStarAria': 'Daj Curriculum Workspace gwiazdkę na GitHubie',
  ...
  'newproj.importClaudeZip': 'Importuj Backup ZIP',
  'newproj.importClaudeZipTitle': 'Importuj eksport .zip z Backup',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że Curriculum Workspace jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do Curriculum Workspace — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z Curriculum Workspace — bez pobierania.',
