...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'Curriculum Workspace را راه‌اندازی کنید',
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به Curriculum Workspace، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Curriculum Workspace را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به Curriculum Workspace در GitHub ستاره بدهید',
  ...
  'newproj.importClaudeZipTitle': 'وارد کردن یک فایل .zip صادر شده از Backup',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Curriculum Workspace در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Curriculum Workspace — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Curriculum Workspace ارائه می‌شود — نیازی به دانلود نیست.',
