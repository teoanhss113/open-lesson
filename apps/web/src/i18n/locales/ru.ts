...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройте Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Curriculum Workspace (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Откройте Curriculum Workspace как MCP-сервер для вашего кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставить Curriculum Workspace звезду на GitHub',
  ...
  'newproj.importClaudeZip': 'Импортировать ZIP-файл из Backup',
  'newproj.importClaudeZipTitle': 'Импортировать экспорт `.zip` из Backup',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Curriculum Workspace запущен, и повторите попытку.',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Curriculum Workspace — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Curriculum Workspace — загрузка не нужна.',
