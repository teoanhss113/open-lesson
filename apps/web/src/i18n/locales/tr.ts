...
export const tr: Dict = {
  ...
  'settings.welcomeTitle': 'Curriculum Workspace kurulumu',
  ...
  'settings.mcpServerHint': 'Curriculum Workspace\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'entry.githubStarAria': 'Curriculum Workspace\u2019a GitHub üzerinde yıldız ver',
  ...
  'newproj.importClaudeZip': 'Backup ZIP’i içe aktar',
  'newproj.importClaudeZipTitle': 'Bir Backup .zip’ini içe aktarın',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. Curriculum Workspace\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': 'Curriculum Workspace ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'Curriculum Workspace ile birlikte gelir — indirme gerekmez.',
