...
export const de: Dict = {
  ...
  'settings.welcomeTitle': 'Curriculum Workspace einrichten',
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu Curriculum Workspace zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle Curriculum Workspace als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.githubStarAria': 'Curriculum Workspace auf GitHub einen Stern geben',
  ...
  'newproj.importClaudeZip': 'Backup ZIP importieren',
  'newproj.importClaudeZipTitle': 'Einen Backup .zip-Export importieren',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass Curriculum Workspace läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit Curriculum Workspace gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit Curriculum Workspace ausgeliefert — kein Download nötig.',
