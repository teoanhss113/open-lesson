...
export const fr: Dict = {
  ...
  'settings.welcomeTitle': 'Configurer Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon Curriculum Workspace (Terminal et apps GUI peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Docs pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth':
    'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Exposez Curriculum Workspace comme serveur MCP pour votre agent de code.',
  ...
  'settings.privacyHint': 'What data is shared with the Curriculum Workspace team',
  'settings.privacyConsentKicker': 'Help us improve Curriculum Workspace',
  'settings.privacyConsentLead': 'Curriculum Workspace can share usage data with our team to help us improve. This includes:',
  ...
  'entry.githubStarAria': 'Mettre une étoile à Curriculum Workspace sur GitHub',
  ...
  'newproj.importClaudeZip': 'Importer un ZIP Backup',
  'newproj.importClaudeZipTitle': 'Importer une exportation .zip Backup',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'Curriculum Workspace est en cours d\'exécution et réessayez.',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec Curriculum Workspace — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec Curriculum Workspace — aucun téléchargement nécessaire.',
  ...
  'settings.memoryStarterProjectDesc': 'Curriculum Workspace v0.5 — chat-driven design editor',
