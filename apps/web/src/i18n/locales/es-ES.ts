...
export const esES: Dict = {
  ...
  'settings.welcomeTitle': 'Configura Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de Curriculum Workspace (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Expón Curriculum Workspace como servidor MCP para tu agente de código.',
  ...
  'entry.githubStarAria': 'Dar una estrella a Curriculum Workspace en GitHub',
  ...
  'newproj.importClaudeZip': 'Importar ZIP de Backup',
  'newproj.importClaudeZipTitle': 'Importar una exportación .zip de Backup',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que Curriculum Workspace esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con Curriculum Workspace — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con Curriculum Workspace — sin descarga.',
