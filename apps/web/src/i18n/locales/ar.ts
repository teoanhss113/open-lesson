...
export const ar: Dict = {
  ...
  'settings.welcomeTitle': 'إعداد Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ Curriculum Workspace (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'كشف Curriculum Workspace كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'entry.githubStarAria': 'منح Curriculum Workspace نجمة على GitHub',
  ...
  'newproj.importClaudeZip': 'استيراد ZIP من Backup',
  'newproj.importClaudeZipTitle': 'استيراد تصدير .zip من Backup',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل Curriculum Workspace ثم أعد المحاولة.',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع Curriculum Workspace - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع Curriculum Workspace - لا حاجة للتحميل.',
