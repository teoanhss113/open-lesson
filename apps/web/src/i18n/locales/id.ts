...
export const id: Dict = {
  ...
  'settings.welcomeTitle': 'Siapkan Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon Curriculum Workspace (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Ekspos Curriculum Workspace sebagai server MCP untuk agen koding Anda.',
  ...
  'entry.githubStarAria': 'Beri star Curriculum Workspace di GitHub',
  ...
  'newproj.importClaudeZip': 'Impor ZIP Backup',
  'newproj.importClaudeZipTitle': 'Impor file .zip hasil ekspor Backup',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan Curriculum Workspace berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan Curriculum Workspace - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan Curriculum Workspace - tidak perlu diunduh.',
