...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o Curriculum Workspace',
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do Curriculum Workspace (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Exponha o Curriculum Workspace como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao Curriculum Workspace no GitHub',
  ...
  'newproj.importClaudeZip': 'Importar ZIP do Backup',
  'newproj.importClaudeZipTitle': 'Importar uma exportação .zip do Backup',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o Curriculum Workspace está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Curriculum Workspace — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Curriculum Workspace — sem download.',
