...
export const it: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Curriculum Workspace (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Curriculum Workspace.',
  ...
  'settings.mcpServerHint': 'Esponi Curriculum Workspace come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Curriculum Workspace',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Curriculum Workspace',
  'settings.privacyConsentLead': 'Curriculum Workspace può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'newproj.importClaudeZip': 'Importa un ZIP Backup',
  'newproj.importClaudeZipTitle': 'Importa un\'esportazione .zip Backup',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Curriculum Workspace sia in esecuzione e riprova.',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con Curriculum Workspace — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Curriculum Workspace — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': 'Curriculum Workspace v0.5 — editor di design guidato da chat',
