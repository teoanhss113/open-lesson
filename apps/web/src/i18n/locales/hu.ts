...
export const hu: Dict = {
  ...
  'settings.welcomeTitle': 'Curriculum Workspace beállítása',
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az Curriculum Workspace daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az Curriculum Workspacehoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az Curriculum Workspacet MCP-szerverként a kódügynököd számára.',
  ...
  'entry.githubStarAria': 'Csillagozd meg az Curriculum Workspace projektet a GitHubon',
  ...
  'newproj.importClaudeZip': 'Backup ZIP importálása',
  'newproj.importClaudeZipTitle': 'Backup .zip export importálása',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az Curriculum Workspace fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.tabBuiltInHint': 'Az Curriculum Workspacenal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az Curriculum Workspacegal érkezik — letöltés nem szükséges.',
