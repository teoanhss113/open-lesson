...
export const en: Dict = {
  ...
  'settings.welcomeTitle': 'Set up AI Curriculum Workspace',
  ...
  'settings.mcpServerHint': 'Expose AI Curriculum Workspace as an MCP server for your coding agent.',
  ...
  'settings.privacyConsentLead': 'The AI Curriculum Workspace can share usage data with our team to help us improve. This includes:',
  ...
  'settings.mcpCapabilityDefault':
    'Default to the project and file you have open in the AI Curriculum Workspace, so you can say "build this in my app" without re-stating which curriculum file.',
  ...
  'settings.memoryStarterProjectDesc': 'AI Curriculum Workspace v0.5 — curriculum editor',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use AI Curriculum Workspace from other IDEs, scripts, and automations.',
  ...
  'tasks.primitiveOrbitBody': 'A persistent runtime for long-running or recurring agent work.',
  'tasks.primitiveOrbitMetaOn': 'Daily summary enabled',
  'tasks.primitiveOrbitMetaOff': 'Manual only',
  'tasks.primitiveRoutinesTitle': 'Routines',
  'tasks.primitiveRoutinesBody': 'Durable task definitions that survive after a single chat ends.',
  'tasks.primitiveRoutinesMeta': 'Product shell ready',
  'tasks.primitiveSchedulesTitle': 'Schedules',
  'tasks.primitiveSchedulesBody': 'Time or event triggers that decide when a routine should run.',
  'tasks.primitiveSchedulesMeta': 'Branch pending',
  'tasks.primitiveArtifactsTitle': 'Live artifacts',
  'tasks.primitiveArtifactsBody': 'Reports and notes that keep updating while an agent works.',
  'tasks.primitiveArtifactsMeta': 'Preview model',
  'tasks.orbitTitle': 'Orbit Daily connector summary',
  'tasks.orbitStatusOn': 'Daily · {time}',
  'tasks.orbitStatusOff': 'Paused · manual only',
  'tasks.orbitMetaOn': 'Connector digest is scheduled',
  ...
  'tasks.orbitPattern': 'Routine · connector digest',
