...
const enDict = {
  ...
  'settings.welcomeTitle': 'Set up Open Lesson',
  ...
  'settings.agentInstall.pathHint':
    'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth':
    'Authenticate with the vendor CLI (sign in or add API credentials) before returning to the workspace.',
  ...
  'settings.curriculum': 'Curriculum Defaults',
  'settings.curriculumHint': 'Manage default settings for curriculum workspace.',
  'settings.curriculum.defaultAgeGroup': 'Default Age Group',
  'settings.curriculum.defaultAgeGroupHint': 'The default age group for newly created curriculum projects.',
  'settings.curriculum.defaultLevel': 'Default Lesson Level',
  'settings.curriculum.defaultLevelHint': 'The default difficulty level for new lessons.',
  'settings.curriculum.defaultSkillId': 'Default AI Skill',
  'settings.curriculum.defaultSkillIdHint': 'The default curriculum skill to select for new conversations.',
  'settings.curriculum.ageK12': 'K-12',
  'settings.curriculum.agePrimary': 'Primary (Ages 5-11)',
  'settings.curriculum.ageSecondary': 'Secondary (Ages 11-18)',
  'settings.curriculum.ageAdult': 'Adult (18+)',
  'settings.curriculum.levelBeginner': 'Beginner',
  'settings.curriculum.levelIntermediate': 'Intermediate',
  'settings.curriculum.levelAdvanced': 'Advanced',
  'settings.curriculum.fallbackSkillLabel': 'Curriculum Quality Analyzer (curriculum-analysis)',
  ...
  'settings.mcpServerHint': 'Expose Open Lesson as an MCP server for your coding agent.',
  'settings.externalMcpTitle': 'Teaching resource servers',
  'settings.externalMcpHint': 'Curated tools for web extraction, diagrams, charts, PDFs, and accessibility checks.',
  ...
  'settings.privacyHint': 'What data is shared with our team',
  'settings.privacyConsentKicker': 'Help us improve the workspace',
  'settings.privacyConsentLead': 'Open Lesson can share usage data with our team to help us improve. This includes:',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your projects directly.',
  'settings.mcpDaemonError':
    "Couldn't reach the local daemon to resolve install paths ({error}). Make sure the daemon is running, then reopen this panel.",
  ...
  'settings.mcpCapabilityDefault':
    'Default to the project and file you have open in Open Lesson, so you can say "build this in my app" without re-stating which curriculum file.',
  'settings.mcpRunningNote':
    'The daemon must be running for MCP tool calls to succeed. If you started your coding agent before opening the workspace, restart the agent so it can reach the live daemon.',

  'entry.tabDesigns': 'Designs',
  'entry.tabTemplates': 'Templates',
  'entry.templatesKicker': 'Rendering catalogue',
  'entry.templatesLede':
    'Use rendering templates for slide decks, live artifacts, prototypes, and curriculum documents.',
  'entry.tabDesignSystems': 'Design systems',
  'entry.designSystemsKicker': 'Visual rules',
  'entry.designSystemsLede':
    'Choose the visual system that controls typography, spacing, color, and component rules for generated materials.',
  ...
  'workspaceTabs.showHidden': 'Show hidden tabs',
  ...
  'pluginShare.title': 'Share plugin',
  'pluginShare.copyInstallCommand': 'Copy install command',
  'pluginShare.copyPluginId': 'Copy plugin ID',
  'pluginShare.copyShareLink': 'Copy share link',
  'pluginShare.copyMarkdownBadge': 'Copy markdown badge',
  'pluginShare.openSourceGithub': 'Open source on GitHub',
  'pluginShare.openSource': 'Open source',
  'pluginShare.openHomepage': 'Open homepage',
  'pluginShare.openMarketplace': 'Open in marketplace',
  'pluginShare.copied': 'Copied',
  'homeHero.attachFiles': 'Attach files',
  'homeHero.run': 'Run',
  'homeHero.runDisabledTitle': 'Type something to run',
  'homeHero.keyboardHint': 'to run · Shift+↵ for new line',
  ...
  'homeHero.hint.liveArtifact': 'Build an interactive HTML/CSS/JS artifact you can preview live.',
  'homeHero.hint.hyperframes': 'Author HTML-based motion: captions, audio-reactive visuals, scene transitions.',
  'homeHero.hint.createPlugin': 'Author a reusable Open Design plugin and add it to My plugins.',
  ...
  'pluginsHome.count': '{shown} of {total}',
  ...
  'entry.githubStarAria': 'GitHub Repository',
  ...
  'newproj.importClaudeZip': 'Import Backup ZIP',
  'newproj.importClaudeZipTitle': 'Import a Backup .zip export',
  ...
  'chat.example1Title': 'Draft a Lesson Plan',
  'chat.example1Tag': 'Lesson Plan',
  'chat.example1Prompt':
    'Design a detailed 45-minute lesson plan for "The Water Cycle" (Grade 4 Science). Include learning objectives (knowledge & core competencies), warm-up activities, guided discovery, hands-on interactive practices, and a quick formative assessment worksheet at the end. Format the output clearly for teachers.',
  'chat.example2Title': 'Design a Teaching Guide',
  'chat.example2Tag': 'Teaching Guide',
  'chat.example2Prompt':
    'Create a teaching guide accompanied by an 8-slide lesson script for the topic "Fractions and Fraction Division" (Grade 5 Math). Each slide should detail: slide title, interactive visual illustrations (e.g., fraction pies), classroom activities, and step-by-step teacher speaking notes.',
  'chat.example3Title': 'Create Homework & Rubric',
  'chat.example3Tag': 'Homework',
  'chat.example3Prompt':
    'Design a homework worksheet along with a grading rubric for a Grade 6 writing project on "Protecting Our Local Environment". The worksheet should include 3 levels of questions (recall, application, creative writing), and the rubric should detail clear grading criteria on a 10-point scale.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure the daemon is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.uploadFolder.title': 'Upload a folder',
  'designFiles.uploadFolder.label': 'Upload folder',
  ...
  'designFiles.groupByStage': 'Curriculum Stage',
  'designFiles.groupByFolder': 'Folder',
  'designFiles.groupBySize': 'Size',
  'designFiles.filterByLabel': 'Filter',
  'designFiles.filterAll': 'All files',
  'designFiles.familySlides': 'Slides',
  'designFiles.familyDocs': 'Documents',
  'designFiles.familyVideo': 'Video',
  'designFiles.familyAudio': 'Audio',
  'designFiles.familyData': 'Data',
  'designFiles.familyWeb': 'Web / HTML',
  'designFiles.stageMaterial': 'Materials',
  'designFiles.stageHomework': 'Homework & Practice',
  'designFiles.sizeTiny': 'Tiny (< 100 KB)',
  'designFiles.sizeSmall': 'Small (< 1 MB)',
  'designFiles.sizeMedium': 'Medium (< 10 MB)',
  'designFiles.sizeLarge': 'Large (< 100 MB)',
  'designFiles.sizeHuge': 'Huge (≥ 100 MB)',
  'designFiles.rootFolder': 'Project root',
  'slideViewer.loading': 'Loading slides…',
  'slideViewer.fallback': 'Parsing slides locally (file too large for server preview)…',
  'slideViewer.parsedLocally': 'Local preview',
  'slideViewer.parsedLocallyTitle': 'Slides parsed in your browser because the server preview was unavailable.',
  'slideViewer.unavailable': 'No slide preview available for this file.',
  'slideViewer.prev': 'Previous slide',
  'slideViewer.next': 'Next slide',
  'slideViewer.position': '{current} / {total}',
  'slideViewer.openInTab': 'Open full slide deck',
  'slideViewer.thumbnailAria': 'Go to slide {n}',
  ...
  'designFiles.folderItemCount': '{n} items',
  ...
  'paletteTweaks.palette.coral': 'Coral - default',
  'paletteTweaks.palette.electric': 'Electric',
  'paletteTweaks.palette.acidForest': 'Acid forest',
  'paletteTweaks.palette.risograph': 'Risograph',
  'paletteTweaks.palette.monoNoir': 'Mono noir',
  'fileViewer.comment': 'Comment',
  'fileViewer.inspect': 'Inspect',
  'fileViewer.edit': 'Edit',
  'fileViewer.draw': 'Draw',
  'fileViewer.visualPreview': 'Visual Preview',
  'fileViewer.textView': 'Text View',
  'fileViewer.commentPicker': 'Picker',
  'fileViewer.commentPickerTitle': 'Pick one element',
  'fileViewer.commentPods': 'Pods',
  'fileViewer.commentPodsTitle': 'Draw a pod selection',
  'fileViewer.inspectHintClose': 'Close Inspect Hint',
  'fileViewer.inspectHintAction': 'tune its style',
  'fileViewer.commentHintAction': 'leave a comment',
  'fileViewer.targetHintPrefix': 'Click any element with',
  'fileViewer.inspectPanelClose': 'Close inspect',
  'fileViewer.inspectPanelColors': 'Colors',
  'fileViewer.inspectPanelText': 'Text',
  'fileViewer.inspectPanelBackground': 'Background',
  'fileViewer.inspectPanelTypography': 'Typography',
  'fileViewer.inspectPanelSize': 'Size',
  'fileViewer.inspectPanelWeight': 'Weight',
  'fileViewer.inspectPanelAlign': 'Align',
  'fileViewer.inspectPanelSpacingShape': 'Spacing & Shape',
  'fileViewer.inspectPanelPadding': 'Padding',
  'fileViewer.inspectPanelRadius': 'Radius',
  'fileViewer.inspectPanelResetElement': 'Reset element',
  'fileViewer.inspectPanelSaving': 'Saving…',
  'fileViewer.inspectPanelSaved': 'Saved ✓',
  'fileViewer.inspectPanelSaveToSource': 'Save to source',
  ...
  'fileViewer.zoomFit': 'Fit to screen',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with the workspace — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with the workspace — no download needed.',
  ...
  'settings.memoryStarterProjectDesc': 'Open Lesson v0.5 — curriculum editor',
  ...
  // Curriculum keys
  'curriculum.status.draft': 'Draft',
  'curriculum.status.in-review': 'In Review',
  'curriculum.status.approved': 'Approved',
  'curriculum.status.archived': 'Archived',
  'curriculum.risk.high': 'High Risk',
  'curriculum.risk.medium': 'Medium Risk',
  'curriculum.risk.low': 'Low Risk',
  'curriculum.risk.passed': 'Passed',
  'curriculum.sidebar.lessonPlans': 'Lesson Plans',
  'curriculum.sidebar.teachingGuides': 'Teaching Guides',
  'curriculum.sidebar.slides': 'Teaching Slides',
  'curriculum.sidebar.feedback': 'Feedback & Surveys',
  'curriculum.sidebar.analysis': 'AI Analysis',
  'curriculum.sidebar.riskReviews': 'Risk Reviews',
  'curriculum.action.generateLessonPlan': 'Generate Lesson Plan',
  'curriculum.action.analyzeCurriculum': 'Analyze Curriculum',
  'curriculum.action.validateRollout': 'Validate Rollout',
  'curriculum.hero.title': 'What lesson do you want to design today?',
  'curriculum.hero.subtitle': 'Enter learning objectives, select a curriculum skill below, or type @ to reference a lesson plan.',
  'curriculum.hero.placeholder': 'Describe a lesson, learning objective, or type @ to search lesson plans, teaching guides, and skills...',
  'newproj.courseNameLabel': 'Course Name',
  'newproj.moduleNameLabel': 'Module Name',
  'newproj.lessonTitleLabel': 'Lesson Title',
  'newproj.ageGroupLabel': 'Age Group',
  'newproj.ageFromLabel': 'From age',
  'newproj.ageFromPlaceholder': 'From',
  'newproj.ageToLabel': 'To age',
  'newproj.ageToPlaceholder': 'To',
  'newproj.levelLabel': 'Level',
  'newproj.curriculumVersionLabel': 'Version',
  'newproj.titleCurriculumWorkspace': 'New curriculum workspace',
  'newproj.curriculumWorkspaceIntro': 'Create one project folder first. Lesson Plan, Teaching Guide, Slides, Material, and Homework artifacts are organized inside the workspace after creation.',
  'newproj.curriculumStarterLabel': 'Starter template',
  'newproj.createCurriculumWorkspace': 'Create workspace',
  'newproj.curriculumKindLabel': 'Curriculum Kind',
  'newproj.curriculumKind.syllabus': 'Syllabus',
  'newproj.curriculumKind.syllabusHint': 'Course scope, outcomes, sequence',
  'newproj.curriculumKind.lessonPlan': 'Lesson Plan',
  'newproj.curriculumKind.teachingGuide': 'Teaching Guide',
  'newproj.curriculumKind.slides': 'Teaching Slides',
  'newproj.curriculumKind.material': 'Material',
  'newproj.curriculumKind.materialHint': 'Teacher/student resources',
  'newproj.curriculumKind.homework': 'Homework',
  'newproj.curriculumKind.homeworkHint': 'Practice, rubric, answer key',
  'newproj.curriculumKind.curriculumReview': 'Curriculum Review',
  'newproj.curriculumKind.rolloutValidation': 'Rollout Validation',
  'curriculum.filter.all': 'All',
  'curriculum.filter.lessonPlans': 'Lesson Plans',
  'curriculum.filter.teachingGuides': 'Teaching Guides',
  'curriculum.filter.slides': 'Teaching Slides',
  'curriculum.filter.reviews': 'Reviews',
  'home.confirmReplaceTitle': 'Replace current prompt?',
  'home.confirmReplaceBody': 'Using {title} will replace the text currently in the input.',
  'home.confirmReplaceAction': 'Replace',
  'workspace.metaCourse': 'Course',
  'workspace.metaModule': 'Module',
  'workspace.metaLesson': 'Lesson',
  'workspace.metaAge': 'Age',
  'workspace.metaLevel': 'Level',
  'workspace.metaVersion': 'Version',
  'integrations.kicker': 'System connections',
  'integrations.title': 'Integrations',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Open Lesson from other IDEs, scripts, and automations.',
  'integrations.badge': 'Agent-ready',
  ...
  'integrations.skillsComingSoon': 'Coming soon',
  ...
  'tasks.new': 'New',
  'tasks.filterAll': 'All',
  'tasks.filterScheduled': 'Scheduled',
  'tasks.filterRunning': 'Running',
  'tasks.filterDone': 'Done',
  'tasks.slotTrigger': 'Trigger',
  'tasks.slotPattern': 'Pattern',
  'tasks.slotRuntime': 'Runtime',
  'tasks.slotOutput': 'Output',
  ...
  'tasks.primitiveOrbitBody': 'A scheduled briefing that helps teachers keep lesson examples current.',
  'tasks.primitiveOrbitMetaOn': 'Daily knowledge summary enabled',
  'tasks.primitiveOrbitMetaOff': 'Manual only',
  'tasks.primitiveRoutinesTitle': 'Teaching brief',
  'tasks.primitiveRoutinesBody': 'A saved daily prompt focused on curriculum updates, examples, and classroom relevance.',
  'tasks.primitiveRoutinesMeta': 'Teacher-focused default',
  'tasks.primitiveSchedulesTitle': 'Schedules',
  'tasks.primitiveSchedulesBody': 'A simple time-based run for the daily teaching knowledge summary.',
  'tasks.primitiveSchedulesMeta': 'Daily schedule',
  'tasks.primitiveArtifactsTitle': 'Live artifacts',
  'tasks.primitiveArtifactsBody': 'A refreshable note teachers can reuse while preparing lessons.',
  'tasks.primitiveArtifactsMeta': 'Lesson-ready output',
  'tasks.orbitTitle': 'Daily teaching knowledge summary',
  'tasks.orbitStatusOn': 'Daily · {time}',
  'tasks.orbitStatusOff': 'Paused · manual only',
  'tasks.orbitMetaOn': 'Teaching knowledge summary is scheduled',
  'tasks.orbitMetaOff': 'Open Orbit settings to enable',
  'tasks.orbitPreviewOn': 'orbit_daily.html · live artifact',
  'tasks.orbitPreviewOff': 'No run scheduled',
  'tasks.orbitTriggerOn': 'Schedule · daily at {time}',
  'tasks.orbitTriggerOff': 'Manual · run on demand',
  'tasks.orbitPattern': 'Routine · teaching knowledge summary',
  'tasks.orbitRuntime': 'Orbit · daemon scheduled',
  'tasks.orbitOutput': 'Live artifact · refreshable report',
  'tasks.orbitArtifactMetaOn': 'Refreshes after each run',
  'tasks.orbitArtifactMetaOff': 'Waiting for schedule',
  'tasks.orbitArtifactBody': '# Daily teaching knowledge summary\nNew references, classroom examples, and curriculum-relevant updates\nHighlights become a refreshable live artifact for lesson preparation.',

  // McpClientSection keys
  'settings.mcp.optionalTools': 'Optional tools for finding, extracting, and rendering classroom-ready source material.',
  'settings.mcp.addServer': 'Add teaching server',
  'settings.mcp.noServers': 'No MCP servers configured.',
  'settings.mcp.addHint': 'Click "Add teaching server" to choose a curated default for web extraction, diagrams, charts, accessibility checks, or PDFs.',
  'settings.mcp.saved': 'Saved',
  'settings.mcp.saving': 'Saving…',
  'settings.mcp.saveChanges': 'Save changes',
  'settings.mcp.savedAt': 'Stored at',
  'settings.mcp.pickServer': 'Pick a teaching server',
  'settings.mcp.closePicker': 'Close picker',
  'settings.mcp.pickerHint': 'Curated defaults only. Choose tools that support lesson research and artifact preparation.',
  'settings.mcp.filterPlaceholder': 'Filter by name, transport, capability…',
  'settings.mcp.noMatchingServers': 'No teaching servers match "{query}". Try clearing the filter.',
  'settings.mcp.homepage': 'Homepage',
  'settings.mcp.try': 'Try:',
  'settings.mcp.enabled': 'Enabled',
  'settings.mcp.disabled': 'Disabled',
  'settings.mcp.displayNamePlaceholder': 'Display name (optional)',
  'settings.mcp.expandToEdit': 'Expand to edit',
  'settings.mcp.moveUp': 'Move up',
  'settings.mcp.moveDown': 'Move down',
  'settings.mcp.removeServer': 'Remove this MCP server',
  'settings.mcp.collapseServer': 'Collapse this MCP server',
  'settings.mcp.expandServer': 'Expand this MCP server',
  'settings.mcp.collapse': 'Collapse',
  'settings.mcp.expand': 'Expand',
  'settings.mcp.needHelp': "Need help? Map your MCP server's JSON config using the example below.",
  'settings.mcp.jsonExample': 'Example MCP JSON',
  ...
  'settings.mcp.conversionHttpHint': 'use url + headers instead of command / args',
  'settings.mcp.oauthHint': "Save first, then click Connect to grant Open Design access via the provider's OAuth flow.",
  'settings.mcp.oauthConnected': 'Connected.',
  'settings.mcp.oauthWaiting': 'Waiting for authorization…',
  'settings.mcp.oauthWaitingHint': "Approve in the browser tab that opened. We'll catch the callback automatically — or click Refresh below if you completed it already.",
  'settings.mcp.oauthNotConnected': 'Not connected.',
  'settings.mcp.oauthNotConnectedHint': "Click Connect to grant Open Design access via the provider's OAuth flow.",
  'settings.mcp.oauthReauthenticate': 'Reauthenticate (replaces the existing token)',
  'settings.mcp.oauthConnecting': 'Connecting…',
  'settings.mcp.oauthReconnect': 'Reconnect',
  'settings.mcp.oauthRecheck': 'Re-check token status against the daemon',
  'settings.mcp.oauthChecking': 'Checking…',
  'settings.mcp.oauthRefresh': 'Refresh',
  'settings.mcp.oauthDisconnecting': 'Disconnecting…',
  'settings.mcp.oauthDisconnect': 'Disconnect',
  'settings.mcp.oauthApprovedRefresh': 'I’ve approved — Refresh',
  'settings.mcp.oauthApprovedHint': 'I\'ve completed authorization — check connection status now',
  'settings.mcp.oauthBrowserNotOpened': "Browser didn't open?",
  'settings.mcp.oauthOpenPage': 'Open authorization page',
  'settings.mcp.mcpServerTitle': 'Teaching resource servers',

  // RoutinesSection keys
  'settings.routines.title': 'Routines',
  'settings.routines.newRoutine': 'New routine',
  'settings.routines.name': 'Name',
  'settings.routines.prompt': 'Prompt',
  'settings.routines.schedule': 'Schedule',
  'settings.routines.project': 'Project',
  'settings.routines.createNew': 'Create a new project each run',
  'settings.routines.createNewHint': 'A fresh, isolated workspace per fire.',
  'settings.routines.reuse': 'Reuse an existing project',
  'settings.routines.reuseHint': 'Each run lives as a new conversation inside the project.',
  'settings.routines.pickProject': '— Pick a project —',
  'settings.routines.cancel': 'Cancel',
  'settings.routines.create': 'Create',
  'settings.routines.creating': 'Creating…',
  'settings.routines.noRoutines': 'No routines yet.',
  'settings.routines.noRoutinesHint': 'Click New routine to schedule an unattended agent run.',
  'settings.routines.runNow': 'Run now',
  'settings.routines.pause': 'Pause',
  'settings.routines.resume': 'Resume',
  'settings.routines.hideHistory': 'Hide history',
  'settings.routines.history': 'History',
  'settings.routines.delete': 'Delete',
  'settings.routines.loadingRuns': 'Loading runs…',
  'settings.routines.noRuns': 'No runs yet.',
  'settings.routines.openProject': 'Open project',
  'settings.routines.paused': 'paused',
  'settings.routines.subtitle': 'Scheduled, unattended agent sessions that run on their own.',
  'settings.routines.navHint': 'Schedule unattended agent runs',
  'settings.routines.minuteOfEveryHour': 'Minute of every hour',
  'settings.routines.timeField': 'Time',
  'settings.routines.timezoneField': 'Timezone',
  'settings.routines.openProjectTitle': 'Open the project this run wrote to',
  'settings.routines.deleteConfirm': 'Delete this routine? Past runs and their projects are kept.',
  'settings.routines.namePlaceholder': 'Morning briefing',
  'settings.routines.promptPlaceholder': 'Pull yesterday\'s activity and summarize...',
  'settings.routines.hourly': 'Hourly',
  'settings.routines.daily': 'Daily',
  'settings.routines.weekdays': 'Weekdays',
  'settings.routines.weekly': 'Weekly',
  'settings.routines.errorPickProject': 'Pick a project to reuse, or switch to "Create new each run"',
  'settings.routines.targetNewProject': '→ new project each run',
  'settings.routines.targetReuseProject': '→ reuse: {projectName}',
  'settings.routines.nextRun': 'next: {time}',
  'settings.routines.lastRun': 'last:',
  'settings.routines.manual': 'manual',
  'settings.routines.scheduled': 'scheduled',
  'settings.routines.descHourly': 'Runs every hour at :{minute}',
  'settings.routines.descDaily': 'Runs daily at {time} {tz}',
  'settings.routines.descWeekdays': 'Runs Mon–Fri at {time} {tz}',
  'settings.routines.descWeekly': 'Runs every {day} at {time} {tz}',
  'settings.routines.weekdayShort.0': 'Sun',
  'settings.routines.weekdayShort.1': 'Mon',
  'settings.routines.weekdayShort.2': 'Tue',
  'settings.routines.weekdayShort.3': 'Wed',
  'settings.routines.weekdayShort.4': 'Thu',
  'settings.routines.weekdayShort.5': 'Fri',
  'settings.routines.weekdayShort.6': 'Sat',
  'settings.routines.weekdayLong.0': 'Sunday',
  'settings.routines.weekdayLong.1': 'Monday',
  'settings.routines.weekdayLong.2': 'Tuesday',
  'settings.routines.weekdayLong.3': 'Wednesday',
  'settings.routines.weekdayLong.4': 'Thursday',
  'settings.routines.weekdayLong.5': 'Friday',
  'settings.routines.weekdayLong.6': 'Saturday',
  'settings.mediaProviders.subHint': 'Image / video / audio',
  'settings.mediaProviders.reloaded': 'Reloaded',
  'settings.mediaProviders.comingSoon': 'Coming soon',
  'settings.mediaProviders.comingSoonHint': 'We track these for the roadmap; the daemon doesn’t ship a client yet, so there’s nothing to configure.',
  'settings.mediaProviders.docs': 'Docs',
  'examples.scenarioLiveArtifacts': 'Live Artifacts',
  'examples.scenarioOperation': 'Operation',
  'mcp.category.imageGeneration': 'Image generation',
  'mcp.category.imageGenerationHint': 'Models that produce raster, vector or video assets.',
  'mcp.category.imageEditing': 'Image editing',
  'mcp.category.imageEditingHint': 'Local post-processing, OCR and CV-driven edits.',
  'mcp.category.webCapture': 'Web capture',
  'mcp.category.webCaptureHint': 'Render a URL into an image so the agent can see what it built.',
  'mcp.category.designSystems': 'Design systems',
  'mcp.category.designSystemsHint': 'Figma read/write, design-token translation, brand inspiration.',
  'mcp.category.uiComponents': 'UI components',
  'mcp.category.uiComponentsHint': 'Designer-grade components, blocks and landing-page material.',
  'mcp.category.dataViz': 'Data viz',
  'mcp.category.dataVizHint': 'Charts and diagrams as proper image artifacts.',
  'mcp.category.publishing': 'Publishing',
  'mcp.category.publishingHint': 'Push generated artifacts to a public URL.',
  'mcp.category.utilities': 'Utilities',
  'mcp.category.utilitiesHint': 'Filesystem, fetch, GitHub and similar generic tools.',
  'plugins.details.contextBundlesHint': 'Skills, design systems, MCP servers and other refs the plugin will pull in at apply time.',
  'plugins.details.contextSkills': 'Skills',
  'plugins.details.contextDesignSystem': 'Design system',
  'plugins.details.contextCraft': 'Craft',
  'plugins.details.contextAtoms': 'Atoms',
  'plugins.details.contextAssets': 'Assets',
  'plugins.details.contextMcpServers': 'MCP servers',
  'workspaceTabs.startNewProject': 'Start a new project',
  'workspaceTabs.workspace': 'Workspace',
  'chat.comments.selectionElement': 'Selected element',
  'chat.comments.selectionVisual': 'Visual mark',
  'chat.comments.selectionPod': 'Selection pod',
  'chat.comments.selectionPodMany': '{n} selected elements',
  'plugins.source.official': 'Official',
  'plugins.source.mine': 'My plugins',
  'plugins.source.mineSingular': 'My plugin',
  'plugins.source.officialCount': '{n} installed official plugins',
  'plugins.source.mineCount': '{n} installed user plugins',
  'plugins.emptyInstallPrefix': 'No plugins installed yet. Browse Official or add your own with',
  'plugins.emptyQuery': 'No {source} results for “{query}”.',
  'plugins.emptySource': 'No {source} plugins available.',
  'plugins.marketplaceEmpty': 'No plugins installed yet. Try',
  'plugins.applying': 'Applying…',
  'plugins.viewDetailsFor': 'View details for {title}',
  'plugins.nextActions': 'Plugin next actions',
  'plugins.ready': 'Plugin ready',
  'plugins.readyHint': 'Send the next step to the agent so it can run the od CLI.',
  'plugins.agentActionSent': 'Sent to the agent. The CLI run will continue in chat.',
  'plugins.filesReadyForMine': '{n} files ready for My plugins',
  'plugins.sending': 'Sending…',
  'plugins.addToMine': 'Add to My plugins',
  'skills.searchPlaceholder': 'Search skills…',
  'skills.searchAria': 'Search skills',
  'skills.empty': 'No skills available yet.',
  'skills.emptyQuery': 'No skills found for “{query}”.',
